...
%     end
 ...
 %hleg = legend('Consumer','Manufactures','HiTec','Other');
    text(0.5,2.2,'ini:','HorizontalAlignment','right')
    text(0.5,1.9,'end:','HorizontalAlignment','right')
    text(1.2,2.2,num2str(t_s(1)),'HorizontalAlignment','right')
    text(1.2,1.9,num2str(t_s(end)),'HorizontalAlignment','right')
    xlabel ('Consumer   Manufactures    HiTec        Health       Other')
    ylabel ('Unrestricted weights')
    title ('US minimum variance portfolio composition: 5 industry portfolios')
%     p=plot(sdp,rho, 'r');
